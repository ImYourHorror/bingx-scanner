...
<th data-key="gap" title="BingX vs вчерашний TW-клоуз (REF CLOSE); стабилен при любой сессии"><svg class="bxico" width="13" height="13" viewBox="0 0 500 500"><path fill="#2962ff" d="M 74.268 158.688 L 216.747 158.711 L 217.506 338.161 L 145.466 337.657 L 145.445 229.983 L 74.2 229.871 L 74.268 158.688 Z"/><circle fill="#2962ff" cx="270.59" cy="192.178" r="35.956"/><polygon fill="#2962ff" points="343.41 158.808 426.417 158.896 351.232 336.856 269.104 336.679 342.837 158.951"/></svg>ГЭП% (TW)<span class="ar"></span></th>
